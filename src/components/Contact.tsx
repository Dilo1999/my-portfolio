import cvPdf from '../assets/Dilshan-Senanayaka-Resume.pdf';
            ...
            <div className="contact-grid">
                ...
                <div className="contact-info">
                  <div className="contact-item">
                    ...
                    <div className="contact-details">
                      ...
                      <a
                        href="mailto:nimeshdilshan440@gmail.com"
                        className="contact-value"
                      >
                        nimeshdilshan440@gmail.com
                      </a>
                    </div>
                  </div>
                  <div className="contact-item">
              ...
              <div>
                ...
                <div className="contact-links">
                  ...
                  >
                    <svg className="contact-link-icon" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a
                    href={cvPdf}
                    download="Dilshan-Senanayaka-Resume.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="contact-link"
                  >
